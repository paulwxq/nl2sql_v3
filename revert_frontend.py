...
content = content.replace(helper_func, "# ========== 主区域 ==========")
...
content = content.replace(new_hist_loop, old_hist_loop)
...
content = content.replace(new_new_chat, old_new_chat)

with open("frontend/app.py", "w", encoding="utf-8") as f:
    f.write(content)
print("Reverted app.py successfully!")
